...
namespace Labs.Lab2
{
    public class Lab2_2Window : GameWindow
    {
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            Matrix4 m1;
            Matrix4.CreateRotationZ(0.8f, out m1);
            m1 = m1 * Matrix4.CreateTranslation(0.5f, 0.5f, 0); 
            ...
            Matrix4 m2 = Matrix4.CreateTranslation(-0.5f, 0.5f, 0f);
            Matrix4 m3;
            Matrix4.CreateRotationZ(0.8f, out m3);
            m2 = m2 * m3;
